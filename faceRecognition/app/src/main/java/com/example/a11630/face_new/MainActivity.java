...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    Button btn_change,btn_opt,btn_in,btn_delete,btn_out,btn_daka,btn_xiugai;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // btn_opt.setOnClickListener(this);
        ...
        btn_daka=findViewById(R.id.daka);
        ...
        btn_xiugai=findViewById(R.id.xiugai);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.change){
            Intent in=new Intent(this,identity.class);
            startActivity(in);
        }
        else if(v.getId()==R.id.in){
            Intent in=new Intent(this,in.class);
            startActivity(in);
        }else  if(v.getId()==R.id.daka){
            Intent in=new Intent(this,daka_in.class);
            startActivity(in);
        }else if(v.getId()==R.id.delete){
            Intent in=new Intent(this,delete.class);
            startActivity(in);
        }
        else if(v.getId()==R.id.xiugai){
            Intent in=new Intent(this,xiugai.class);
            startActivity(in);
        }
            else{
            System system = null;
